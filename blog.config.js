...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'tutorial, physics, mathematic, condensed matter, 凝聚态物理, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，here is my Notes of Condensed matter theory and related mathematic🎉Welcome!',
